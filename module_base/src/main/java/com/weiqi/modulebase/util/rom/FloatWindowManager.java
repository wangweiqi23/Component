...
public class FloatWindowManager {
    ...
    public static final int REQUEST_CODE_PERMISSION_FLOAT_WINDOW = 911;
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (RomUtils.checkIsVivoRom()) {
                    ...
                    try {
                        ...
                        startActivityOrForResult(context, intent);
                    } catch (Exception e) {
                        Log.e(TAG, Log.getStackTraceString(e));
                    }
                }
...
//        imageView.setImageResource(R.drawable.app_icon);
    ...
    /**
     * 启动系统界面申请权限
     * @param context 传入Activity使用startActivityForResult以在onActivityResult接受回调，否则无回调
     */
    public void startActivityOrForResult(Context context, Intent intent) {
        if (context instanceof Activity) {
            ((Activity) context).startActivityForResult(intent,
                    REQUEST_CODE_PERMISSION_FLOAT_WINDOW);
        } else {
