...
class EasyPermissions {
    ...
    interface PermissionCallbacks extends ActivityCompat.OnRequestPermissionsResultCallback {

        void onPermissionsGranted(int requestCode, List<String> perms);

        void onPermissionsDenied(int requestCode, List<String> perms);

        void onPermissionsDeniedWithoutMoreCheck();
     ...
     */
    @SuppressLint("NewApi")
    static void requestPermissions(@NonNull PermissionAssistFragment fragment,
                                   int requestCode,
        ...
        if (shouldShowRationale(fragment, perms)) {
            RationaleDialog.show(fragment, requestCode, perms);
        } else {
     ...
     * Activity}'s {@link ActivityCompat
     ...
     */
    static boolean somePermissionPermanentlyDenied(@NonNull Fragment fragment,
     ...
     */
    private static boolean permissionPermanentlyDenied(@NonNull Fragment fragment,
                    ...
                    if (ann.value() == requestCode) {
                        ...
                        if (method.getParameterTypes().length > 0) {
                            throw new RuntimeException(
                                    "Cannot execute method " + method.getName() + " because it is" +
                                            " non-void method and/or has input parameters.");
                        }
