...
import com.weiqi.modulebase.widget.slidebar.ScrollBar;
...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    private void drawSlideBar(Canvas canvas) {
        ...
        switch (this.scrollBar.getGravity()) {
            ...
            case BOTTOM_FLOAT:
            default:
                offsetY = getHeight() - scrollBar.getHeight(getHeight()) - DensityUtil.dip2px(SLIDE_VERTICLE_PADDING);
                break;
        }
        ...
        int width = scrollBar.getSlideView().getWidth() - DensityUtil.dip2px(PADDING);
